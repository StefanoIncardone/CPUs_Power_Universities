...
public abstract class Pannello
{
			...
			IllegalArgumentException
	{
		if( scala > 1 )
		{
			throw new IllegalArgumentException
				(
					"Errore: il fattore di scala pone il frame a"	+
					"una dimensione maggiore dello schermo corrente"
				);
		}
		else if( scala < 0.1 )
		{
	...
	public static void setTitolo( JPanel pannello, String titolo )
	{
		pannello.setBorder(	BorderFactory.createTitledBorder
			( null, titolo, TitledBorder.TOP, TitledBorder.DEFAULT_POSITION ) );
	}
}
